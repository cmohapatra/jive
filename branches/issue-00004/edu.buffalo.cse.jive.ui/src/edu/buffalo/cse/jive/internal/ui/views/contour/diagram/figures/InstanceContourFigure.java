...
/**
 * A Draw2d figure used for visualizing an {@code InstanceContour}.
 * 
 * @see InstanceContour
 * @author Jeffrey K Czyz
 */
public class InstanceContourFigure extends JavaContourFigure {
	 ...
	 */
	public InstanceContourFigure(String id) {
		super(id);
	}
