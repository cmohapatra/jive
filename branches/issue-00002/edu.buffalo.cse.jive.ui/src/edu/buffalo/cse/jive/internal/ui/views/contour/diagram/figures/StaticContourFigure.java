...
/**
 * A Draw2d figure used for visualizing an {@code StaticContour}.
 * 
 * @see StaticContour
 * @author Jeffrey K Czyz
 */
public class StaticContourFigure extends JavaContourFigure {
	 ...
	 */
	public StaticContourFigure(String id) {
		super(id);
	}
