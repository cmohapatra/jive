...
import edu.buffalo.cse.jive.ui.search.queries.ExceptionThrownSearchQuery;
 ...
 */
public class ExceptionThrownSearchPage extends AbstractJiveSearchPage {
	...
	public IJiveSearchQuery createSearchQuery() {
		...
		return new ExceptionThrownSearchQuery(pattern, exceptionText.getText());
	}
